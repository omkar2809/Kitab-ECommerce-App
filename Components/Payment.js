...
const STRIPE_PK = 'pk_test_51IEWzNDAn9R6bpYdVUVh3IizpT7Bn2QoJkbQRLwfmgh0xrQFu7hVbDDSNCjmtNqGqxSNe5erpLqMILDgauhOvcnn002koPHW6Z'
                        ...
                        <form>
                            <div class="card-holder">
                                    ...
                                    <div id="card-element" class="card-element">
                                        ...
                                        <label>
                                            <span>CVC</span>
                                            <input type="password" size="4" data-stripe="cvc">
                                        </label>
                                        </div>
                                ...
                                <div class="pay-btn">
                                    <input type="submit" class="btn  btn-lg btn-color" value="Pay Now" />
                                </div>
